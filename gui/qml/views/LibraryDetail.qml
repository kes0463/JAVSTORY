...
Item {
    ...
    function processSnapNavigationKey(key, mods) {
        ...
        if (key === Qt.Key_Return || key === Qt.Key_Enter || key === Qt.Key_Space) {
            ...
            lightboxImage.source = "file:///" + LibraryModel.detail.stillPaths[i]
            lightboxOverlay.visible = true
            return true
        }
    ...
    /// ScrollView 내부 Flickable이 방향키로 스크롤 포커스를 가져가면 루트 Keys가 동작하지 않음
    Timer {
                ...
                Column {
                    ...
                    Column {
                        ...
                        TextArea {
                            id: edSynKoQuick
                            width: parent.width
                            height: Math.min(220, Math.max(120, implicitHeight))
                            ...
                            ListView {
                                ...
                                delegate: Rectangle {
                                    ...
                                    Column {
                                        ...
                                        Label { text: "scene_id"; font.pixelSize: Theme.fontCaption - 1; color: Theme.textMuted }
                                        TextField {
                                            width: parent.width
                                            text: sceneId
                                        ...
                                        Label { text: "시간 구간 time_range"; font.pixelSize: Theme.fontCaption - 1; color: Theme.textMuted }
                                        TextField {
                                            width: parent.width
                                            text: timeRange
                                        ...
                                        Label { text: "라벨"; font.pixelSize: Theme.fontCaption - 1; color: Theme.textMuted }
                                        TextField {
                                            width: parent.width
                                            text: sceneLabel
                                            color: Theme.textPrimary
                                        ...
                                        Label { text: "요약"; font.pixelSize: Theme.fontCaption - 1; color: Theme.textMuted }
                                        TextArea {
                                            width: parent.width
                                            height: Math.min(100, Math.max(56, implicitHeight))
                                            text: sceneSummary
                                            wrapMode: TextArea.Wrap
                                            selectByMouse: true
                                            color: Theme.textPrimary
                                        ...
                                        Label { text: "톤 · 태그(쉼표)"; font.pixelSize: Theme.fontCaption - 1; color: Theme.textMuted }
                                        Row {
                                            width: parent.width
                                            spacing: 6
                                            TextField {
