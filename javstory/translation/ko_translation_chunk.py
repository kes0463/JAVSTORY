...
환경: `JAVSTORY_TRANSLATION_PROFILE`(default|keeper|deepseek_chat|budget|qwen35|qwen3_14|gemma3_12), `JAVSTORY_TRANSLATION_OPENROUTER_MODEL`,
...
async def translate_ja_segments_to_ko_async(
    ...
    *,
    ...
    try:
        ...
        if tier.get("provider") == "ollama":
            await ollama_unload_model(tier["model"], logger_func=log)
